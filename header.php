...
<body <?php body_class(); ?> itemscope itemtype="http://schema.org/WebPage">
  ...
  <?php if($loading_animation){
    ...
    <?php endif; ?>
      <div class="ajax_loader"><div class="ajax_loader_1"><?php if($loading_image != ""){ ?><div class="ajax_loader_2"><img itemprop="image" aria-disabled="true" src="<?php echo $loading_image; ?>" alt="" /></div><?php } else{ qode_loading_spinners(); } ?></div></div>
      ...
      <div class="vertical_menu_area_inner">
        ...
        <div class="vertical_logo_wrapper">
          ...
          <div class="q_logo_vertical">
              ...
              <span aria-disabled="true" aria-hidden="true" class="hidden">Scott Arboretum Logo</span>
              <img itemprop="image" aria-disabled="true" class="normal" src="<?php echo $logo_image; ?>" alt="The Scott Arboretum of Swarthmore College"/>
              <img itemprop="image" aria-disabled="true" class="light" src="<?php echo $logo_image_light; ?>" alt="The Scott Arboretum of Swarthmore College"/>
              <img itemprop="image" aria-disabled="true" class="dark" src="<?php echo $logo_image_dark; ?>" alt="The Scott Arboretum of Swarthmore College"/>
            </a>
          </div>
      ...
      <div class="vertical_menu_area_bottom_logo">
        <div class="vertical_menu_area_bottom_logo_inner">
          <a href="javascript: void(0)">
            <img itemprop="image" aria-disabled="true" src="<?php echo esc_url($qode_options_proya['vertical_logo_bottom']); ?>" alt="vertical_menu_area_bottom_logo"/>
          </a>
        </div>
      </div>
    <?php } ?>
           ...
           <?php } ?>
            <div class="form_holder_outer">
              <div class="form_holder">
                ...
                <a class="qode_search_submit" href="javascript:void(0)" aria-label="Search">
          ...
          <div class="header_inner_left">
            ...
            <div class="logo_wrapper">
              ...
              <span aria-disabled="true" aria-hidden="true" class="hidden">Scott Arboretum Logo</span>
                  ...
                  <img itemprop="image" aria-disabled="true" class="light" src="<?php echo $logo_image_light; ?>" alt="The Scott Arboretum of Swarthmore College"/>
                  <img itemprop="image" aria-disabled="true" class="dark" src="<?php echo $logo_image_dark; ?>" alt="The Scott Arboretum of Swarthmore College"/>
                  <img itemprop="image" aria-disabled="true" class="sticky" src="<?php echo $logo_image_sticky; ?>" alt="The Scott Arboretum of Swarthmore College"/>
                  <img itemprop="image" aria-disabled="true" class="mobile" src="<?php echo $logo_image_mobile; ?>" alt="The Scott Arboretum of Swarthmore College"/>
                  <?php if($enable_popup_menu == 'yes'){ ?>
                    <img itemprop="image" aria-disabled="true" class="popup" src="<?php echo $logo_image_popup; ?>" alt="The Scott Arboretum of Swarthmore College"/>
                  <?php } ?>
                </a>
              </div>
                            <?php if($header_bottom_appearance == "fixed_hiding") { ?>
                            <div class="q_logo_hidden">						<a itemprop="url" href="<?php echo home_url('/'); ?>">
              <span aria-disabled="true" aria-hidden="true" class="hidden">Scott Arboretum Logo</span><img itemprop="image" aria-disabled="true" alt="The Scott Arboretum of Swarthmore College" src="<?php echo $logo_image_fixed_hidden; ?>" style="height: 100%;"></a></div>
                            <?php } ?>
            </div>
              ...
              <div class="header_inner_right">
                  ...
                  <?php if(is_active_sidebar('woocommerce_dropdown')) {
                    ...
                    <?php if(isset($qode_options_proya['enable_search']) && $qode_options_proya['enable_search'] == 'yes') {
                      ...
                      ?>
                      <a class="search_button <?php echo esc_attr($search_type_class); ?> <?php echo esc_attr($header_button_size); ?>" aria-label="Search" href="javascript:void(0)">
                                                <?php $qodeIconCollections->getSearchIcon(qodef_option_get_value('search_icon_pack')); ?>
                      </a>
...
<?php } ?>
    ...
    <a id='back_to_top' href='#' aria-label="Back to Top">
      <span class="fa-stack">
        <i class="fa fa-arrow-up" style=""><span aria-disabled="true" aria-hidden="true" class="hidden">Back to Top</span></i>
      </span>
    </a>
  <?php } ?>
    <?php if($enable_popup_menu == "yes"){ ?>
      ...
      <div class="close_container">
        ...
        <?php } ?>
            <div class="search_close_holder">
              <div class="side_menu_button">
                <a class="fullscreen_search_close" aria-label="Close the search dialog" href="javascript:void(0)">
                                    <?php $qodeIconCollections->getSearchClose(qodef_option_get_value('search_icon_pack')); ?>
                </a>
              </div>
            </div>
              ...
              <div class="form_holder">
                ...
                <div class="field_holder">
                  ...
                  <div class="line"></div>
                                ...
                                <a class="qode_search_submit search_submit" href="javascript:void(0)" aria-label="Search">
                                    <?php $qodeIconCollections->getSearchIcon(qodef_option_get_value('search_icon_pack')); ?>
                                </a>
              </div>
            </form>
...
?>
      ...
      <?php } ?>
      <div class="content_inner <?php echo $animation;?> " id="main" tabindex="-1">
      <?php if($qode_options_proya['page_transitions'] == "1" || $qode_options_proya['page_transitions'] == "2" || $qode_options_proya['page_transitions'] == "3" || $qode_options_proya['page_transitions'] == "4" || ($animation == "updown") || ($animation == "fade") || ($animation == "updown_fade") || ($animation == "leftright")){ ?>
